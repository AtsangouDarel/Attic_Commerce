      ...
      body: Column(
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    VxSwiper.builder(
                      ...
                      10.heightBox,
                      "10.000XAF".text.color(blueColor).fontFamily(bold).size(18).make(),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              "0.00XAF".text.color(blueColor).size(16).fontFamily(bold).make(),
                      ...
                      10.heightBox,
                      "This is a dummy item ans dummy description here...".text.color(darkFontGrey).make(),
                       ...
                       ListView(
                        ...
                        children: List.generate(
                          ...
                          (index) => ListTile(
                          title: itemDetailButtonList[index].text.fontFamily(semibold).make(),
                    ...
                    10.heightBox,
                    //i copied this widget from home screen
          ...
          SizedBox(
            ...
            height: 60,
            child: ourButton(
              color: blueColor, onPress: () {}, textColor: whiteColor, title: "Add to cart"
            ),
          ),
        ],
      ),
